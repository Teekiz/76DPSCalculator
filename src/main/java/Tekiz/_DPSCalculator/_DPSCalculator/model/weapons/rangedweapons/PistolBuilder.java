...
public class PistolBuilder extends RangedBuilder<PistolBuilder>
{
	...
	public PistolBuilder(String weaponName, WeaponType weaponType, HashMap<Integer, Double> weaponDamageByLevel, int apCost)
	{
	...
	public Pistol build()
	{
		return new Pistol(weaponName, weaponType, weaponDamageByLevel, apCost, magazineSize, fireRate,
