...
public class WeaponMapper
{
	 ...
	 * @return The {@link Weapon} represented as a DTO ({@link WeaponNameDTO}) or null if the weapon is null.
	 */
	public WeaponWithDetailsDTO convertToWithDetailsDTO(Weapon weapon)
	{
		if (weapon==null){return null;}
		return new WeaponWithDetailsDTO(weapon.getWeaponName(), weapon.getWeaponType().toString(),
			weapon.getDamageType().toString(), weapon.getWeaponDamageByLevel());
	}
}
